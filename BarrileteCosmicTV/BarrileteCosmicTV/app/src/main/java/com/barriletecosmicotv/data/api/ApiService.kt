...
interface ApiService {
    ...
    // NEW: endpoint para obtener días restantes y expiración (requiere Bearer)
    @GET("me/subscription")
...
// LoginResponse (servidor devuelve success + token + user; message/expiresAt opcionales)
...
// NEW: respuesta real de /me/subscription según tu server.js
data class SubscriptionResponse(
    val ok: Boolean,
    val username: String,
    val expiresAt: String?,     // puede venir null
    val daysRemaining: Int,
    val timestamp: String
)

// NEW: change password request/response
